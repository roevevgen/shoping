...
@section('content')
    ...
    <main class="main">
        ...
        <div class="bg-soft-gray about-mid sec-padding sec-mar">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-7">
                        ...
                        <div class="count-up-wrp">
                            <div>
                                <h2 class="color-brand bm-0"><span class="count">100</span>+</h2>
                                Employees
                            </div>
                            ...
                            <div>
                                <h2 class="color-brand bm-0"><span class="count">10</span>+</h2>
                                Stores
                            </div>

                            <div>
                                <h2 class="color-brand bm-0"><span class="count">1500</span>+</h2>
                                Satisfied customers
                            </div>
                        </div>
                        <!--counter wrap-->
        ...
        <div class="container gutter-5 sec-mar">
            <div class="title text-center mid-sep"><h2>Our Team</h2></div>
            ...
            <div class="row team-list">
                ...
                <div class="col-sm-3">
                    <div class="team-wrap">
                        ...
                        <div class="bottom">
                            <h5 class="bm-0">Celina Martin</h5>
                            Manager
                        </div>
                    </div>
                </div>
