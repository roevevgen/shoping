                        ...
                        <li class="product">
                            ...
                            <div class="pdt-right">
                                ...
                                <div class="disc bm-20">
                                    Globally expedite real-time best practices whereas collaborative catalysts for change. Efficiently extend enterprise imperatives after resource-leveling infomediaries.
                                </div>

                                <div class="price bm-25"><del>$189.00</del><ins>$189.00 </ins></div>

                                <div class="btn-wrap">
                                    <a href="#" class="btn add-to-cart pri-bg" data-toggle="tooltip" data-placement="top" title="Add to Cart"><i class="pe-7s-cart"></i> ADD TO CART</a>
                                    <a href="#" class="btn add-to-favorite bdr" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><i class="pe-7s-like"></i></a>

                                    <a href="#quick-view-popup" class="btn bdr" data-toggle="tooltip" data-placement="top" data-rel="quickview-popup" title="Quick View"><i class="pe-7s-look"></i></a>
                                </div>
                                <!--action-->
                            </div>
                        </li>
